...
import '../../home_search/utils/search_verses_utils.dart';

/// Small screen search
class VersesSearch extends SearchDelegate<List> {
  final HomeBloc? bloc;
  final double? height;
  Book setBook = Book();
  VersesSearch(BuildContext context, this.bloc, this.height);

  @override
  String get searchFieldLabel => "Search a Verse";
  ...
  Widget buildLeading(BuildContext context) {
    return IconButton(
      onPressed: () => close(context, bloc!.state.verses),
  ...
  Widget searchThis(BuildContext context) {
    var matchQuery = filterVersesByQry(query.toLowerCase(), bloc!.state.verses);
