...
import '../../data/models/exts/verseext.dart';
...
class SearchVerseItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final verses = verse.content.split("##");
      ...
      child: Card(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(
                verseItemTitle(verse.verseNo, verse.title),
                maxLines: 1,
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    if (isSearching)
                      TagItem(
                          tagText: refineTitle(verse.versebook), height: height),
